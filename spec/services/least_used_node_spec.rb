...
RSpec.describe LeastUsedNode, type: :service do
  ...
  let!(:slot1_1) { Fabricate(:slot_idle, node: node1, name: "slot1_1", execution_type: "io") }
  ...
  let!(:slot1_4) { Fabricate(:slot_idle, node: node1, name: "slot1_4", execution_type: "cpu") }
  let!(:slot1_5) { Fabricate(:slot_idle, node: node1, name: "slot1_5", execution_type: "cpu") }
  let!(:slot1_6) { Fabricate(:slot_idle, node: node1, name: "slot1_6", execution_type: "cpu") }
  let!(:slot1_7) { Fabricate(:slot_idle, node: node1, name: "slot1_7", execution_type: "cpu") }
  let!(:slot1_8) { Fabricate(:slot_idle, node: node1, name: "slot1_8", execution_type: "cpu") }
  ...
  let!(:slot2_3) { Fabricate(:slot_idle, node: node2, name: "slot2_3", execution_type: "io") }
  ...
  let!(:slot3_4) { Fabricate(:slot_idle, node: node3, name: "slot3_4", execution_type: "io") }
  let!(:slot3_5) { Fabricate(:slot_idle, node: node3, name: "slot3_5", execution_type: "cpu") }
  let!(:slot3_6) { Fabricate(:slot_idle, node: node3, name: "slot3_6", execution_type: "cpu") }

  let!(:slot4_1) { Fabricate(:slot_idle, node: node4, name: "slot4_1", execution_type: "io") }
  let!(:slot4_2) { Fabricate(:slot_idle, node: node4, name: "slot4_2", execution_type: "cpu") }
  let!(:slot4_3) { Fabricate(:slot_idle, node: node4, name: "slot4_3", execution_type: "network") }

  let!(:slot5_1) { Fabricate(:slot_idle, node: node5, name: "slot5_1", execution_type: "io") }
  let!(:slot5_2) { Fabricate(:slot_idle, node: node5, name: "slot5_2", execution_type: "cpu") }
  let!(:slot5_3) { Fabricate(:slot_idle, node: node5, name: "slot5_3", execution_type: "network") }

  let!(:slot6_1) { Fabricate(:slot_idle, node: node6, name: "slot6_2", execution_type: "cpu") }
